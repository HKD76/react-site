...
export default function TestimonialData() {
  return (
    <section className="testimonial-data">
      <motion.div
        className="testimonial-data-container"
        variants={fadeInUpContainer}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true }}
      >
        <motion.div variants={fadeInUpItem} className="testimonial-data-content">
          <h2 className="testimonial-data-title">
            La <span className="highlight">mesure</span> de la{" "}
            <span className="highlight">performance</span>, accessible partout
            dans le monde
          </h2>
          <p className="testimonial-data-text">
            Notre logiciel <span className="highlight">TRS/MES</span> s'intègre
            à votre ERP existant et est fourni avec un module de captation des
            arrêts (<span className="highlight">RTBOX</span>). L'analyse des
            arrêts machine permet une gestion efficace des rebuts et une
          ...
          <p className="testimonial-data-text">
            ...
            basée sur des données hebergées sur votre serveur,{" "}
            <span className="highlight">RealTiMES</span> peut fournir des
            recommandations intelligentes pour optimiser vos processus de
            production.
          </p>
          <p className="testimonial-data-text">
        ...
        <div className="testimonial-data-bloc">
          <motion.div variants={fadeInUpItem} className="testimonial-data-info">
            <p className="testimonial-data-number">#1</p>
            <p className="testimonial-data-desc">
              Normand en suivi de performance industrielle
            </p>
          </motion.div>
          <motion.div variants={fadeInUpItem} className="testimonial-data-info">
            <p className="testimonial-data-number">+20</p>
            <p className="testimonial-data-desc">
              ans d'expérience en Lean Management
            </p>
          </motion.div>
          <motion.div variants={fadeInUpItem} className="testimonial-data-info">
            <p className="testimonial-data-number">+50</p>
            <p className="testimonial-data-desc">
              clients internationaux déjà équipés
            </p>
          </motion.div>
          <motion.div variants={fadeInUpItem} className="testimonial-data-info">
            <p className="testimonial-data-number">4,7/5</p>
            <p className="testimonial-data-desc">
              la note que l'on donne à notre solution
            </p>
          </motion.div>
        </div>
      </motion.div>
